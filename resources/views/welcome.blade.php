...
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/smartphone.png">--}}
{{--                                        کالای دیجیتال--}}
{{--                                    </a>--}}
...
{{--                                        </li>--}}
{{--                                        <div class="bg-image">--}}
{{--                                            <img src="{{ asset('static/home/assets/images') }}/menu-main/digital.png" alt="">--}}
{{--                                        </div>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/makeup.png">--}}
{{--                                        آرایشی و بهداشتی--}}
{{--                                    </a>--}}
...
{{--                                        </li>--}}
{{--                                        <div class="bg-image">--}}
{{--                                            <img src="{{ asset('static/home/assets/images') }}/menu-main/cosmetic.png" alt="">--}}
{{--                                        </div>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/print.png">--}}
{{--                                        ابزار و اداری--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/suit.png">--}}
{{--                                        مد و پوشاک--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/home.png">--}}
{{--                                        خانه و آشپزخانه--}}
{{--                                    </a>--}}
...
{{--                                        </li>--}}
{{--                                        <div class="bg-image">--}}
{{--                                            <img src="{{ asset('static/home/assets/images') }}/menu-main/kitchen.png" alt="">--}}
{{--                                        </div>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/edit.png">--}}
{{--                                        لوازم و تحریر--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/child.png">--}}
{{--                                        کودک و نوزاد--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li class="main-menu-item category-menu-item menu-item-type-custom">--}}
{{--                                    <a href="#" class="main-menu-link-category">--}}
{{--                                        <img src="{{ asset('static/home/assets/images') }}/menu-main/category/cup.png">--}}
{{--                                        ورزشی و اسپرت--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                            </ul>--}}
...
{{--                                        <div class="item">--}}
{{--                                            <a href="#">--}}
{{--                                                <img src="{{ asset('static/home/assets/images') }}/slider-moment/sm-1.jpg"--}}
{{--                                                     class="w-100"--}}
{{--                                                     alt="">--}}
{{--                                            </a>--}}
...
{{--                                        <div class="item">--}}
{{--                                            <a href="#">--}}
{{--                                                <img src="{{ asset('static/home/assets/images') }}/slider-moment/sm-2.jpg"--}}
{{--                                                     class="w-100"--}}
{{--                                                     alt="">--}}
{{--                                            </a>--}}
{{--                                            <h3 class="product-title">--}}
...
{{--                                        <div class="item">--}}
{{--                                            <a href="#">--}}
{{--                                                <img src="{{ asset('static/home/assets/images') }}/slider-moment/sm-3.jpg"--}}
{{--                                                     class="w-100"--}}
{{--                                                     alt="">--}}
{{--                                            </a>--}}
{{--                                            <h3 class="product-title">--}}
...
{{--                                        <div class="item">--}}
{{--                                            <a href="#">--}}
{{--                                                <img src="{{ asset('static/home/assets/images') }}/slider-moment/sm-4.jpg"--}}
{{--                                                     class="w-100"--}}
{{--                                                     alt="">--}}
{{--                                            </a>--}}
{{--                                            <h3 class="product-title">--}}
{{--                                                <a href="#"> لپ تاپ 16 اینچی اپل مدل MacBook Pro MVVK2 2019 همراه با--}}
{{--                                                    تاچ بار--}}
{{--                                                </a>--}}
{{--                                            </h3>--}}
{{--                                            <div class="price">--}}
...
{{--                                        <div class="item">--}}
{{--                                            <a href="#">--}}
{{--                                                <img src="{{ asset('static/home/assets/images') }}/slider-moment/sm-5.jpg"--}}
{{--                                                     class="w-100"--}}
{{--                                                     alt="">--}}
{{--                                            </a>--}}
{{--                                            <h3 class="product-title">--}}
{{--                                                <a href="#">گوشی موبایل سامسونگ مدل Galaxy S10 SM-G973F/DS دو سیم--}}
{{--                                                    کارت ظرفیت 128 گیگابایت--}}
{{--                                                </a>--}}
{{--                                            </h3>--}}
{{--                                            <div class="price">--}}
...
{{--                        </div>--}}
{{--                        <div id="progressBar">--}}
{{--                            <div class="slide-progress" style="width: 100%; transition: width 5000ms ease 0s;">--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                            <img src="{{ asset('static/home/assets/images') }}/adplacement/a-3.jpg">--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                    <a href="#" class="adplacement-item">--}}
{{--                        <div class="adplacement-sponsored_box">--}}
{{--                            <img src="{{ asset('static/home/assets/images') }}/adplacement/a-10.jpg">--}}
{{--                        </div>--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--            </div>--}}
