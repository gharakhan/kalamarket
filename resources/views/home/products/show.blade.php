        ...
        <div id="breadcrumb">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active open" aria-current="page">گوشی موبایل سامسونگ مدل Galaxy
                        ...
                        <div class="gallery">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body">
                                                            <div id="custom-events">
                                                                <a href="assets/images/page-single-product/product-img/product-img-note10.jpg">
                                                                    <img src="assets/images/page-single-product/product-img/product-img-note10.jpg">
                                                                </a>
                                                                <a href="assets/images/page-single-product/product-img/product-img-note10-big-1.jpg">
                                                                    <img src="assets/images/page-single-product/product-img/product-img-note10-big-1.jpg">
                                                                </a>
                            ...
                            <div class="gallery-item">
                                <div class="gallery-img">
                                    <a href="#">
                                        <div class="zoomWrapper" style="height: 411px; width: 411px;"><img class="zoom-img" id="img-product-zoom" src="assets/images/page-single-product/product-img/product-img-note10.jpg" data-zoom-image="assets/images/page-single-product/product-img/product-img-note10.jpg" width="411" style="position: absolute;"></div>
                                    </a><div id="gallery_01f" style="width:420px;float:right;"><a href="#">
                                        </a>
                                        <ul class="gallery-items owl-carousel owl-theme owl-rtl owl-loaded owl-drag" id="gallery-slider">
                                            ...
                                            <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all; width: 726px;"><div class="owl-item active" style="width: 135.042px; margin-left: 10px;"><li class="item">
                                                            <a href="#" class="elevatezoom-gallery active" data-update="" data-image="assets/images/page-single-product/product-img/product-img-note10-big-1.jpg" data-zoom-image="assets/images/page-single-product/product-img/product-img-note10-big-1.jpg">
                                                                <img src="assets/images/page-single-product/product-img/product-img-note10-big-1.jpg" width="100"></a>
                                                        </li></div><div class="owl-item active" style="width: 135.042px; margin-left: 10px;"><li class="item">
                                                        ...
                                                        </li></div><div class="owl-item" style="width: 135.042px; margin-left: 10px;"><li class="item">
                                                        ...
                                                        </li></div></div></div><div class="owl-nav"><button type="button" role="presentation" class="owl-prev disabled"><i class="fa fa-angle-right"></i></button><button type="button" role="presentation" class="owl-next"><i class="fa fa-angle-left"></i></button></div><div class="owl-dots disabled"></div></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-lg-3 pr">
                                                <section>
                                                    <div class="comments-user-shopping">حسن شجاعی
                                                        ...
                                                        <div class="message-light"><i class="fa fa-thumbs-o-up"></i>خرید این محصول را
                                                            توصیه می‌کنم</div>
                                                    </div>
                                                </section>
                                            </div>
                                                        ...
                                                        <div class="comments-evaluation">
                                                            ...
                                                            <div class="footer">
                                                                <div class="comments-likes">آیا این نظر برایتان
                                                                    مفید بود؟
                                                                    <button class="btn-like js-comment-like" type="submit">بله
                                                                        <span class="count">8</span>
                                                                    </button>
                                                                    <button class="btn-like js-comment-dislike" type="submit">خیر
            ...
            <div class="card-header border-0">
                ...
                <span class="label label-light-success label-rounded font-weight-bold">5</span>
                                ...
                                <li class="navi-footer pt-5 pb-4">
                                    ...
                                    <a class="btn btn-clean font-weight-bold btn-sm d-none" href="#" data-toggle="tooltip" data-placement="right" title="" data-original-title="برای اطلاعات بیشتر کلیک کنید...">بیشتر بدانید</a>
                                </li>
                            </ul>
                            <!--end::Naviigation-->
                        </div>
