<div class="d-block">
            ...
            <div class="header-right">
                <div class="col-lg-3 pr">
                    <div class="header-logo row text-right">
                        <a href="#">
                            <img src="{{ asset('static/home/assets/images/child.png') }}" alt="کالامارکت">
                        </a>
                    </div>
                </div>
                        ...
                        <div class="account-box">
                            <div class="nav-account d-block pl">
                                        <span class="icon-account">
                                            <img src="{{ asset('static/home/assets/images/man.png') }}" class="avator">
                                        </span>
                                                ...
                                                <ul class="product-list-widget">
                                                    <li class="mini-cart-item">
                                                        <div class="mini-cart-item-content">
                                                            ...
                                                            <a href="#" class="mini-cart-item-image d-block">
                                                                <img
                                                                    src="{{ asset('static/home/assets/images') }}/menu-main/img-card.jpg">
                                                            </a>
                                                    ...
                                                    <li class="mini-cart-item">
                                                        <div class="mini-cart-item-content">
                                                            ...
                                                            <a href="#" class="mini-cart-item-image d-block">
                                                                <img
                                                                    src="{{ asset('static/home/assets/images') }}/menu-main/img-card-2.jpg">
                                                            </a>
    ...
    <nav class="sidebar">
        <div class="nav-header">
            ...
            <div class="logo-wrap">
                <a class="logo-icon" href="#"><img alt="logo-icon" src="{{ asset('static/home/assets/images') }}/logo.png"
                                                   width="40"></a>
            </div>
        </div>
